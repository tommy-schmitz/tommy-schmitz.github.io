...
export const compress_into_base_58 = function(msg:string) {
  ...
  const buffer2 = compression.encode(buffer);
  return to_b58(new Uint8Array(buffer2), '123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz');
};
export const decompress_from_base_58 = function(coded_string:string) {
  ...
  const buffer2 = compression.decode(buffer);
